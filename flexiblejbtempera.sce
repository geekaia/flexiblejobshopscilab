...
//        printf("BESTFIT\n")
        tipo = "BESTFIT"
//    elseif bestOrWorst == 11 then // NÃO HÁ NENHUM BENEFÍCIO
...
//    elseif bestOrWorst == 5 then  // FOI COMENTADO POIS NÃO FOI OBSERVADO NENHUMA MELHORA
//       try
//         
